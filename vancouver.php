...
<nav class="nav navbar-inverse">
    <ul class="nav navbar-nav">
        ...
        <tr><th>Store Name</th>
            ...
            <td><a href="delete_store.php?storeID=8&cityID=3">Delete</a></td>
            <td>dsgzsg</td>
            <td>sgsagedg</td>
            <td>7896541234</td>
            <td><img height="50" src="images/"></td>
            <td><a href="delete_store.php?storeID=45&cityID=1">Delete</a></td></tr></table></main>
